					...
					<div class="container">
						<div class="row 200%">
							...
							<div class="8u 12u(mobile)" id="content" style="margin-top:-50px;">
								<article id="main">
									<section>
									<header><h2>Add Food Image</h2></header>
                                    <form action = "../Alter/submit.php" method = "post" enctype="multipart/form-data">
        		                        <header><h3>Food Title</h3></header>
                                        <input type="text" name="foodTitle">
                                        ...
                                        <input type="hidden" name="BUCKET" value="Food">
							...
							<div class="4u 12u(mobile)" id="sidebar">
								...
								<section>
									...
									<header>
										<h3>Learn how to submit new food images</h3>
									</header>
									<p>
				        ...
				        <div class="11u 12u(mobile) important(mobile)" id="content">
				                <article id="main">
                                    ...
                                    <tbody>
                                        ...
                                        <?php while( $row1 = $sqlfood->fetch()) : ?>
                                        <tr cellpadding='3' border=1 style='border-collapse:collapse;width:100%;border: 1px solid #000000;'>
                                            <!--Each table column is echoed in to a td cell-->
                                            <td border=1 style='border: 1px solid #000000;'><?php echo $row1['food_id']; ?></td>
                                            <td border=1 style='border: 1px solid #000000;'><?php echo $row1['food_title']; ?></td>
                                            ...
                                            <td border=1 style='border: 1px solid #000000; text-align:center;'>
                                            	...
                                            	<form action="../Alter/delete.php" method="post">
                                                    ...
                                                    <input type="hidden" name="idnum" value="<?php echo $row1['food_id']; ?>">
                                                    <input type="hidden" name="table" value="food">
                                                    <input type="hidden" name="INTERNAL" value="<?php echo $verifyCode;?>">
                                                    <input type="hidden" name="BUCKET" value="Food">
                                                    <input type="hidden" name="IMAGE" value="<?php echo $row1['image']; ?>">
