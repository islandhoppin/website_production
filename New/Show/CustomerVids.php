					...
					<div class="container">
						<div class="row 200%">
							...
							<div class="8u 12u(mobile)" id="content" style="margin-top:-50px;">
								<article id="main">
									<section>
									<header><h2>Add Customer Video Image</h2></header>
                                    <form action = "../Alter/submit.php" method = "post" enctype="multipart/form-data">
        		                        <header><h3>Customer Video Title</h3></header>
                                        <input type="text" name="vidTitle">
                                        <header><h3>Customer Video Link</h3></header>
                                        ...
                                        <input type="hidden" name="BUCKET" value="CustomerVids">
                                        <input type="hidden" name="table" value="customervid">
							...
							<div class="4u 12u(mobile)" id="sidebar">
								...
								<section>
									...
									<header>
										<h3>Learn how to submit new customer videos</h3>
									</header>
									<p>
				        ...
				        <div class="11u 12u(mobile) important(mobile)" id="content">
				                <article id="main">
                                    ...
                                    <tbody>
                                        ...
                                        <?php while( $row1 = $sqlcustvids->fetch()) : ?>
                                        <tr cellpadding='3' border=1 style='border-collapse:collapse;width:100%;border: 1px solid #000000;'>
                                            <!--Each table column is echoed in to a td cell-->
                                            <td border=1 style='border: 1px solid #000000;'><?php echo $row1['vid_id']; ?></td>
                                            <td border=1 style='border: 1px solid #000000;'><?php echo $row1['vid_title']; ?></td>
                                            <td border=1 style='border: 1px solid #000000;'><a href="<?php echo $row1['image']; ?>" target="_blank">Click to Preview</a></td>
                                            <td border=1 style='border: 1px solid #000000;'><a href="<?php echo $row1['video_link']; ?>" target="_blank">Click to view</a></td>
                                            ...
                                            <td border=1 style='border: 1px solid #000000; text-align:center;'>
                                            	<form action="/New/Show/UpdateCustVid.php" method="post">
                                                    <input type="hidden" name="id" value="<?php echo $row1['vid_id'];?>">
                                                    <input type="hidden" name="table" value="customervid">
                                                    <input type="hidden" name="Title" value="<?php echo $row1['vid_title']; ?>">
                                                    <input type="hidden" name="Image" value="<?php echo $row1['image']; ?>">
                                                    <input type="hidden" name="videoLink" value="<?php echo $row1['video_link']; ?>">
                                            	...
                                            	<form action="../Alter/delete.php" method="post">
                                                    <input type="hidden" name="id" value="vid_id">
                                                    <input type="hidden" name="idnum" value="<?php echo $row1['vid_id']; ?>">
                                                    <input type="hidden" name="table" value="customervid">
                                                    <input type="hidden" name="INTERNAL" value="<?php echo $verifyCode;?>">
                                                    <input type="hidden" name="BUCKET" value="CustomerVids">
                                                    <input type="hidden" name="IMAGE" value="<?php echo $row1['image']; ?>">
