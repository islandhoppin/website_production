<?php
    ...
    if ($onPage == $verifyCode){
    	...
    	$testimonials = $dbconn->prepare("SELECT testimonial_id, title, update, headline, testimonial, date, extra_space, show, star_count, blank_1 FROM testimonials ORDER BY testimonial_id ASC") ; 
