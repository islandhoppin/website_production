<?php
    ...
    if ($onPage == $verifyCode){
	    $special_id = $_POST["id"];
	    $table = $_POST["table"];
	    $special_title = $_POST["Title"];
	    $offer = $_POST["Offer"];
	    $special_order = $_POST["specialOrder"];
	    $show = $_POST["show"];
	    $image = $_POST["Image"];
	    $blank_1 = $_POST["date"];
							...
							<div class="8u 12u(mobile)" id="content" style="margin-top:-50px;">
								<article id="main">
                                    ...
                                    <form action = "../Alter/update.php" method = "post" enctype="multipart/form-data">
                                        ...
                                        <input type="text" name="specialTitle" value = "<?php echo $special_title;?>">
                                        ...
                                        <input type="text" name="specialorder" value = "<?php echo $special_order;?>">
