<?php     
	...
	$testimonials = $dbconn->prepare("SELECT testimonial_id, title, headline, testimonial, crew, tripdate, extra_space, show, preference_order FROM testimonials WHERE show = 'Yes' ORDER BY preference_order DESC") ;
									...
									<?php while( $row5 = $testimonials->fetch()) : ?>
										<article>
											<div>
												...
												<h4 style="padding-top:10px;">Overall Experience: </h4> <i class="fa fa-star" aria-hidden="true"></i><i class="fa fa-star" aria-hidden="true"></i>
