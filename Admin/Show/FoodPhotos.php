...
Function getData($data){
    ...
    if ($onPage == $verifyCode){
        $foodImagesQuery = '{"query":"query {foodImagesCollection (order: orderId_ASC) {items {title orderId show date photo {title description contentType fileName size url width height}}}}"}';
    	$foodImages = getData($foodImagesQuery);
		
		date_default_timezone_set('US/Eastern');
    	$downloadData = "FoodPhotos-" . date("Y-m-d_h:i:sa") . ".csv";
    }
					...
					<div class="container">
				        ...
				        <div class="11u 12u(mobile) important(mobile)" id="content">
				                <article id="main">
									...
									<section>
				                	<center>
				                		<h1 style="color:green">Food Photo Table</h1>
				                	</center>
