...
Function getData($data){
    ...
    if ($onPage == $verifyCode){
        $newsQuery = '{"query":"query {newsCollection (order: orderId_DESC, limit:15, where: {show: true}) {items {header orderId update date photo {title description contentType fileName size url width height}}}}"}';
					...
					<div class="container">
				        ...
				        <div class="11u 12u(mobile) important(mobile)" id="content">
				                <article id="main">
									...
									<section>
				                	<center>
				                		<h1 style="color:green">iHOP News Table</h1>
				                	</center>
								    ...
								    <table border="1" cellspacing="0" cellpadding="10">
							            ...
							            <?php foreach($news['data']['newsCollection']['items'] as $value) : ?>
							            <tr>
							                <th><?php echo $value['header']; ?></th>
							                <th><?php echo $value['orderId']; ?></th>
							                <th><?php echo $value['update']; ?></th>
